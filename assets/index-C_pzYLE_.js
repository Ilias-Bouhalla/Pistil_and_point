...
`)+`
`+f);const E=x+g+r,S=x+f+o,A=tl(s,s.VERTEX_SHADER,E),w=tl(s,s.FRAGMENT_SHADER,S);s.attachShader(v,A),s.attachShader(v,w),t.index0AttributeName!==void 0?s.bindAttribLocation(v,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(v,0,"position"),s.linkProgram(v);function C(R){if(i.debug.checkShaderErrors){const k=s.getProgramInfoLog(v)||"",z=s.getShaderInfoLog(A)||"",W=s.getShaderInfoLog(w)||"",G=k.trim(),U=z.trim(),F=W.trim();let J=!0,Y=!0;if(s.getProgramParameter(v,s.LINK_STATUS)===!1)if(J=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,v,A,w);else{const re=il(s,A,"vertex"),ue=il(s,w,"fragment");Re("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(v,s.VALIDATE_STATUS)+`
...
}`,xb=[new I(1,0,0),new I(-1,0,0),new I(0,1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1)],vb=[new I(0,-1,0),new I(0,-1,0),new I(0,0,1),new I(0,0,-1),new I(0,-1,0),new I(0,-1,0)],ul=new ke,rs=new I,lr=new I;function Mb(i,e,t){let n=new Fo;const s=new Pe,a=new Pe,r=new ct,o=new rd,l=new od,c={},h=t.maxTextureSize,d={[Nn]:Ft,[Ft]:Nn,[dn]:dn},u=new _n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pe},radius:{value:4}},vertexShader:bb,fragmentShader:_b}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const m=new Xt;m.setAttribute("position",new Nt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const v=new ft(m,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=oa;let f=this.type;this.render=function(w,C,_){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||w.length===0)return;this.type===Sl&&(Ee("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=oa);const y=i.getRenderTarget(),H=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),k=i.state;k.setBlending(In),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const z=f!==this.type;z&&C.traverse(function(W){W.material&&(Array.isArray(W.material)?W.material.forEach(G=>G.needsUpdate=!0):W.material.needsUpdate=!0)});for(let W=0,G=w.length;W<G;W++){const U=w[W],F=U.shadow;if(F===void 0){Ee("WebGLShadowMap:",U,"has no shadow.");continue}if(F.autoUpdate===!1&&F.needsUpdate===!1)continue;s.copy(F.mapSize);const J=F.getFrameExtents();s.multiply(J),a.copy(F.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/J.x),s.x=a.x*J.x,F.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/J.y),s.y=a.y*J.y,F.mapSize.y=a.y));const Y=i.state.buffers.depth.getReversed();if(F.camera._reversedDepth=Y,F.map===null||z===!0){if(F.map!==null&&(F.map.depthTexture!==null&&(F.map.depthTexture.dispose(),F.map.depthTexture=null),F.map.dispose()),this.type===hs){if(U.isPointLight){Ee("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}F.map=new gn(s.x,s.y,{format:zi,type:Un,minFilter:xt,magFilter:xt,generateMipmaps:!1}),F.map.texture.name=U.name+".shadowMap",F.map.depthTexture=new ys(s.x,s.y,Wt),F.map.depthTexture.name=U.name+".shadowMapDepth",F.map.depthTexture.format=On,F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=_t,F.map.depthTexture.magFilter=_t}else U.isPointLight?(F.map=new ah(s.x),F.map.depthTexture=new $u(s.x,bn)):(F.map=new gn(s.x,s.y),F.map.depthTexture=new ys(s.x,s.y,bn)),F.map.depthTexture.name=U.name+".shadowMap",F.map.depthTexture.format=On,this.type===oa?(F.map.depthTexture.compareFunction=Y?Ro:wo,F.map.depthTexture.minFilter=xt,F.map.depthTexture.magFilter=xt):(F.map.depthTexture.compareFunction=null,F.map.depthTexture.minFilter=_t,F.map.depthTexture.magFilter=_t);F.camera.updateProjectionMatrix()}const re=F.map.isWebGLCubeRenderTarget?6:1;for(let ue=0;ue<re;ue++){if(F.map.isWebGLCubeRenderTarget)i.setRenderTarget(F.map,ue),i.clear();else{ue===0&&(i.setRenderTarget(F.map),i.clear());const he=F.getViewport(ue);r.set(a.x*he.x,a.y*he.y,a.x*he.z,a.y*he.w),k.viewport(r)}if(U.isPointLight){const he=F.camera,Ce=F.matrix,Ye=U.distance||he.far;Ye!==he.far&&(he.far=Ye,he.updateProjectionMatrix()),rs.setFromMatrixPosition(U.matrixWorld),he.position.copy(rs),lr.copy(he.position),lr.add(xb[ue]),he.up.copy(vb[ue]),he.lookAt(lr),he.updateMatrixWorld(),Ce.makeTranslation(-rs.x,-rs.y,-rs.z),ul.multiplyMatrices(he.projectionMatrix,he.matrixWorldInverse),F._frustum.setFromProjectionMatrix(ul,he.coordinateSystem,he.reversedDepth)}else F.updateMatrices(U);n=F.getFrustum(),S(C,_,F.camera,U,this.type)}F.isPointLightShadow!==!0&&this.type===hs&&x(F,_),F.needsUpdate=!1}f=this.type,g.needsUpdate=!1,i.setRenderTarget(y,H,R)};function x(w,C){const _=e.update(v);u.defines.VSM_SAMPLES!==w.blurSamples&&(u.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new gn(s.x,s.y,{format:zi,type:Un})),u.uniforms.shadow_pass.value=w.map.depthTexture,u.uniforms.resolution.value=w.mapSize,u.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(C,null,_,u,v,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(C,null,_,p,v,null)}function E(w,C,_,y){let H=null;const R=_.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(R!==void 0)H=R;else if(H=_.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const k=H.uuid,z=C.uuid;let W=c[k];W===void 0&&(W={},c[k]=W);let G=W[z];G===void 0&&(G=H.clone(),W[z]=G,C.addEventListener("dispose",A)),H=G}if(H.visible=C.visible,H.wireframe=C.wireframe,y===hs?H.side=C.shadowSide!==null?C.shadowSide:C.side:H.side=C.shadowSide!==null?C.shadowSide:d[C.side],H.alphaMap=C.alphaMap,H.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,H.map=C.map,H.clipShadows=C.clipShadows,H.clippingPlanes=C.clippingPlanes,H.clipIntersection=C.clipIntersection,H.displacementMap=C.displacementMap,H.displacementScale=C.displacementScale,H.displacementBias=C.displacementBias,H.wireframeLinewidth=C.wireframeLinewidth,H.linewidth=C.linewidth,_.isPointLight===!0&&H.isMeshDistanceMaterial===!0){const k=i.properties.get(H);k.light=_}return H}function S(w,C,_,y,H){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&H===hs)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,w.matrixWorld);const z=e.update(w),W=w.material;if(Array.isArray(W)){const G=z.groups;for(let U=0,F=G.length;U<F;U++){const J=G[U],Y=W[J.materialIndex];if(Y&&Y.visible){const re=E(w,Y,y,H);w.onBeforeShadow(i,w,C,_,z,re,J),i.renderBufferDirect(_,null,z,re,w,J),w.onAfterShadow(i,w,C,_,z,re,J)}}}else if(W.visible){const G=E(w,W,y,H);w.onBeforeShadow(i,w,C,_,z,G,null),i.renderBufferDirect(_,null,z,G,w,null),w.onAfterShadow(i,w,C,_,z,G,null)}}const k=w.children;for(let z=0,W=k.length;z<W;z++)S(k[z],C,_,y,H)}function A(w){w.target.removeEventListener("dispose",A);for(const _ in c){const y=c[_],H=w.target.uuid;H in y&&(y[H].dispose(),delete y[H])}}}function Sb(i,e){function t(){let D=!1;const se=new ct;let ne=null;const pe=new ct(0,0,0,0);return{setMask:function(Q){ne!==Q&&!D&&(i.colorMask(Q,Q,Q,Q),ne=Q)},setLocked:function(Q){D=Q},setClear:function(Q,j,be,Ie,ot){ot===!0&&(Q*=Ie,j*=Ie,be*=Ie),se.set(Q,j,be,Ie),pe.equals(se)===!1&&(i.clearColor(Q,j,be,Ie),pe.copy(se))},reset:function(){D=!1,ne=null,pe.set(-1,0,0,0)}}}function n(){let D=!1,se=!1,ne=null,pe=null,Q=null;return{setReversed:function(j){if(se!==j){const be=e.get("EXT_clip_control");j?be.clipControlEXT(be.LOWER_LEFT_EXT,be.ZERO_TO_ONE_EXT):be.clipControlEXT(be.LOWER_LEFT_EXT,be.NEGATIVE_ONE_TO_ONE_EXT),se=j;const Ie=Q;Q=null,this.setClear(Ie)}},getReversed:function(){return se},setTest:function(j){j?ee(i.DEPTH_TEST):ae(i.DEPTH_TEST)},setMask:function(j){ne!==j&&!D&&(i.depthMask(j),ne=j)},setFunc:function(j){if(se&&(j=ru[j]),pe!==j){switch(j){case _r:i.depthFunc(i.NEVER);break;case xr:i.depthFunc(i.ALWAYS);break;case vr:i.depthFunc(i.LESS);break;case Oi:i.depthFunc(i.LEQUAL);break;case Mr:i.depthFunc(i.EQUAL);break;case Sr:i.depthFunc(i.GEQUAL);break;case Er:i.depthFunc(i.GREATER);break;case yr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pe=j}},setLocked:function(j){D=j},setClear:function(j){Q!==j&&(Q=j,se&&(j=1-j),i.clearDepth(j))},reset:function(){D=!1,ne=null,pe=null,Q=null,se=!1}}}function s(){let D=!1,se=null,ne=null,pe=null,Q=null,j=null,be=null,Ie=null,ot=null;return{setTest:function(Ze){D||(Ze?ee(i.STENCIL_TEST):ae(i.STENCIL_TEST))},setMask:function(Ze){se!==Ze&&!D&&(i.stencilMask(Ze),se=Ze)},setFunc:function(Ze,Sn,En){(ne!==Ze||pe!==Sn||Q!==En)&&(i.stencilFunc(Ze,Sn,En),ne=Ze,pe=Sn,Q=En)},setOp:function(Ze,Sn,En){(j!==Ze||be!==Sn||Ie!==En)&&(i.stencilOp(Ze,Sn,En),j=Ze,be=Sn,Ie=En)},setLocked:function(Ze){D=Ze},setClear:function(Ze){ot!==Ze&&(i.clearStencil(Ze),ot=Ze)},reset:function(){D=!1,se=null,ne=null,pe=null,Q=null,j=null,be=null,Ie=null,ot=null}}}const a=new t,r=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},d={},u=new WeakMap,p=[],m=null,v=!1,g=null,f=null,x=null,E=null,S=null,A=null,w=null,C=new De(0,0,0),_=0,y=!1,H=null,R=null,k=null,z=null,W=null;const G=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,F=0;const J=i.getParameter(i.VERSION);J.indexOf("WebGL")!==-1?(F=parseFloat(/^WebGL (\d)/.exec(J)[1]),U=F>=1):J.indexOf("OpenGL ES")!==-1&&(F=parseFloat(/^OpenGL ES (\d)/.exec(J)[1]),U=F>=2);let Y=null,re={};const ue=i.getParameter(i.SCISSOR_BOX),he=i.getParameter(i.VIEWPORT),Ce=new ct().fromArray(ue),Ye=new ct().fromArray(he);function je(D,se,ne,pe){const Q=new Uint8Array(4),j=i.createTexture();i.bindTexture(D,j),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let be=0;be<ne;be++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,pe,0,i.RGBA,i.UNSIGNED_BYTE,Q):i.texImage2D(se+be,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Q);return j}const q={};q[i.TEXTURE_2D]=je(i.TEXTURE_2D,i.TEXTURE_2D,1),q[i.TEXTURE_CUBE_MAP]=je(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),q[i.TEXTURE_2D_ARRAY]=je(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),q[i.TEXTURE_3D]=je(i.TEXTURE_3D,i.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ee(i.DEPTH_TEST),r.setFunc(Oi),Be(!1),ut(Yo),ee(i.CULL_FACE),Je(In);function ee(D){h[D]!==!0&&(i.enable(D),h[D]=!0)}function ae(D){h[D]!==!1&&(i.disable(D),h[D]=!1)}function Ne(D,se){return d[D]!==se?(i.bindFramebuffer(D,se),d[D]=se,D===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=se),D===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=se),!0):!1}function Ae(D,se){let ne=p,pe=!1;if(D){ne=u.get(se),ne===void 0&&(ne=[],u.set(se,ne));const Q=D.textures;if(ne.length!==Q.length||ne[0]!==i.COLOR_ATTACHMENT0){for(let j=0,be=Q.length;j<be;j++)ne[j]=i.COLOR_ATTACHMENT0+j;ne.length=Q.length,pe=!0}}else ne[0]!==i.BACK&&(ne[0]=i.BACK,pe=!0);pe&&i.drawBuffers(ne)}function Le(D){return m!==D?(i.useProgram(D),m=D,!0):!1}const St={[ri]:i.FUNC_ADD,[Ah]:i.FUNC_SUBTRACT,[wh]:i.FUNC_REVERSE_SUBTRACT};St[Rh]=i.MIN,St[Ch]=i.MAX;const qe={[Ph]:i.ZERO,[Dh]:i.ONE,[Lh]:i.SRC_COLOR,[gr]:i.SRC_ALPHA,[kh]:i.SRC_ALPHA_SATURATE,[Uh]:i.DST_COLOR,[Fh]:i.DST_ALPHA,[Ih]:i.ONE_MINUS_SRC_COLOR,[br]:i.ONE_MINUS_SRC_ALPHA,[Oh]:i.ONE_MINUS_DST_COLOR,[Nh]:i.ONE_MINUS_DST_ALPHA,[Bh]:i.CONSTANT_COLOR,[zh]:i.ONE_MINUS_CONSTANT_COLOR,[Gh]:i.CONSTANT_ALPHA,[Vh]:i.ONE_MINUS_CONSTANT_ALPHA};function Je(D,se,ne,pe,Q,j,be,Ie,ot,Ze){if(D===In){v===!0&&(ae(i.BLEND),v=!1);return}if(v===!1&&(ee(i.BLEND),v=!0),D!==Th){if(D!==g||Ze!==y){if((f!==ri||S!==ri)&&(i.blendEquation(i.FUNC_ADD),f=ri,S=ri),Ze)switch(D){case Fi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Jo:i.blendFunc(i.ONE,i.ONE);break;case Zo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case $o:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Re("WebGLState: Invalid blending: ",D);break}else switch(D){case Fi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Jo:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Zo:Re("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case $o:Re("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Re("WebGLState: Invalid blending: ",D);break}x=null,E=null,A=null,w=null,C.set(0,0,0),_=0,g=D,y=Ze}return}Q=Q||se,j=j||ne,be=be||pe,(se!==f||Q!==S)&&(i.blendEquationSeparate(St[se],St[Q]),f=se,S=Q),(ne!==x||pe!==E||j!==A||be!==w)&&(i.blendFuncSeparate(qe[ne],qe[pe],qe[j],qe[be]),x=ne,E=pe,A=j,w=be),(Ie.equals(C)===!1||ot!==_)&&(i.blendColor(Ie.r,Ie.g,Ie.b,ot),C.copy(Ie),_=ot),g=D,y=!1}function st(D,se){D.side===dn?ae(i.CULL_FACE):ee(i.CULL_FACE);let ne=D.side===Ft;se&&(ne=!ne),Be(ne),D.blending===Fi&&D.transparent===!1?Je(In):Je(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),a.setMask(D.colorWrite);const pe=D.stencilWrite;o.setTest(pe),pe&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),mt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ee(i.SAMPLE_ALPHA_TO_COVERAGE):ae(i.SAMPLE_ALPHA_TO_COVERAGE)}function Be(D){H!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),H=D)}function ut(D){D!==Eh?(ee(i.CULL_FACE),D!==R&&(D===Yo?i.cullFace(i.BACK):D===yh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ae(i.CULL_FACE),R=D}function P(D){D!==k&&(U&&i.lineWidth(D),k=D)}function mt(D,se,ne){D?(ee(i.POLYGON_OFFSET_FILL),(z!==se||W!==ne)&&(z=se,W=ne,r.getReversed()&&(se=-se),i.polygonOffset(se,ne))):ae(i.POLYGON_OFFSET_FILL)}function Ke(D){D?ee(i.SCISSOR_TEST):ae(i.SCISSOR_TEST)}function rt(D){D===void 0&&(D=i.TEXTURE0+G-1),Y!==D&&(i.activeTexture(D),Y=D)}function ve(D,se,ne){ne===void 0&&(Y===null?ne=i.TEXTURE0+G-1:ne=Y);let pe=re[ne];pe===void 0&&(pe={type:void 0,texture:void 0},re[ne]=pe),(pe.type!==D||pe.texture!==se)&&(Y!==ne&&(i.activeTexture(ne),Y=ne),i.bindTexture(D,se||q[D]),pe.type=D,pe.texture=se)}function T(){const D=re[Y];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function b(){try{i.compressedTexImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function K(){try{i.texSubImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function Z(){try{i.texSubImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function X(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function me(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function ie(){try{i.texStorage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function Te(){try{i.texStorage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function we(){try{i.texImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function $(){try{i.texImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function te(D){Ce.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),Ce.copy(D))}function ge(D){Ye.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),Ye.copy(D))}function _e(D,se){let ne=c.get(se);ne===void 0&&(ne=new WeakMap,c.set(se,ne));let pe=ne.get(D);pe===void 0&&(pe=i.getUniformBlockIndex(se,D.name),ne.set(D,pe))}function de(D,se){const pe=c.get(se).get(D);l.get(se)!==pe&&(i.uniformBlockBinding(se,pe,D.__bindingPointIndex),l.set(se,pe))}function ze(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),r.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},Y=null,re={},d={},u=new WeakMap,p=[],m=null,v=!1,g=null,f=null,x=null,E=null,S=null,A=null,w=null,C=new De(0,0,0),_=0,y=!1,H=null,R=null,k=null,z=null,W=null,Ce.set(0,0,i.canvas.width,i.canvas.height),Ye.set(0,0,i.canvas.width,i.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:ee,disable:ae,bindFramebuffer:Ne,drawBuffers:Ae,useProgram:Le,setBlending:Je,setMaterial:st,setFlipSided:Be,setCullFace:ut,setLineWidth:P,setPolygonOffset:mt,setScissorTest:Ke,activeTexture:rt,bindTexture:ve,unbindTexture:T,compressedTexImage2D:b,compressedTexImage3D:L,texImage2D:we,texImage3D:$,updateUBOMapping:_e,uniformBlockBinding:de,texStorage2D:ie,texStorage3D:Te,texSubImage2D:K,texSubImage3D:Z,compressedTexSubImage2D:X,compressedTexSubImage3D:me,scissor:te,viewport:ge,reset:ze}}function Eb(i,e,t,n,s,a,r){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Pe,h=new WeakMap;let d;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(T,b){return p?new OffscreenCanvas(T,b):Es("canvas")}function v(T,b,L){let K=1;const Z=ve(T);if((Z.width>L||Z.height>L)&&(K=L/Math.max(Z.width,Z.height)),K<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const X=Math.floor(K*Z.width),me=Math.floor(K*Z.height);d===void 0&&(d=m(X,me));const ie=b?m(X,me):d;return ie.width=X,ie.height=me,ie.getContext("2d").drawImage(T,0,0,X,me),Ee("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+X+"x"+me+")."),ie}else return"data"in T&&Ee("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),T;return T}function g(T){return T.generateMipmaps}function f(T){i.generateMipmap(T)}function x(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(T,b,L,K,Z=!1){if(T!==null){if(i[T]!==void 0)return i[T];Ee("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let X=b;if(b===i.RED&&(L===i.FLOAT&&(X=i.R32F),L===i.HALF_FLOAT&&(X=i.R16F),L===i.UNSIGNED_BYTE&&(X=i.R8)),b===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.R8UI),L===i.UNSIGNED_SHORT&&(X=i.R16UI),L===i.UNSIGNED_INT&&(X=i.R32UI),L===i.BYTE&&(X=i.R8I),L===i.SHORT&&(X=i.R16I),L===i.INT&&(X=i.R32I)),b===i.RG&&(L===i.FLOAT&&(X=i.RG32F),L===i.HALF_FLOAT&&(X=i.RG16F),L===i.UNSIGNED_BYTE&&(X=i.RG8)),b===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.RG8UI),L===i.UNSIGNED_SHORT&&(X=i.RG16UI),L===i.UNSIGNED_INT&&(X=i.RG32UI),L===i.BYTE&&(X=i.RG8I),L===i.SHORT&&(X=i.RG16I),L===i.INT&&(X=i.RG32I)),b===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.RGB8UI),L===i.UNSIGNED_SHORT&&(X=i.RGB16UI),L===i.UNSIGNED_INT&&(X=i.RGB32UI),L===i.BYTE&&(X=i.RGB8I),L===i.SHORT&&(X=i.RGB16I),L===i.INT&&(X=i.RGB32I)),b===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(X=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(X=i.RGBA16UI),L===i.UNSIGNED_INT&&(X=i.RGBA32UI),L===i.BYTE&&(X=i.RGBA8I),L===i.SHORT&&(X=i.RGBA16I),L===i.INT&&(X=i.RGBA32I)),b===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&(X=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(X=i.R11F_G11F_B10F)),b===i.RGBA){const me=Z?ga:We.getTransfer(K);L===i.FLOAT&&(X=i.RGBA32F),L===i.HALF_FLOAT&&(X=i.RGBA16F),L===i.UNSIGNED_BYTE&&(X=me===$e?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(X=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(X=i.RGB5_A1)}return(X===i.R16F||X===i.R32F||X===i.RG16F||X===i.RG32F||X===i.RGBA16F||X===i.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function S(T,b){let L;return T?b===null||b===bn||b===xs?L=i.DEPTH24_STENCIL8:b===Wt?L=i.DEPTH32F_STENCIL8:b===_s&&(L=i.DEPTH24_STENCIL8,Ee("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===bn||b===xs?L=i.DEPTH_COMPONENT24:b===Wt?L=i.DEPTH_COMPONENT32F:b===_s&&(L=i.DEPTH_COMPONENT16),L}function A(T,b){return g(T)===!0||T.isFramebufferTexture&&T.minFilter!==_t&&T.minFilter!==xt?Math.log2(Math.max(b.width,b.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?b.mipmaps.length:1}function w(T){const b=T.target;b.removeEventListener("dispose",w),_(b),b.isVideoTexture&&h.delete(b)}function C(T){const b=T.target;b.removeEventListener("dispose",C),H(b)}function _(T){const b=n.get(T);if(b.__webglInit===void 0)return;const L=T.source,K=u.get(L);if(K){const Z=K[b.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&y(T),Object.keys(K).length===0&&u.delete(L)}n.remove(T)}function y(T){const b=n.get(T);i.deleteTexture(b.__webglTexture);const L=T.source,K=u.get(L);delete K[b.__cacheKey],r.memory.textures--}function H(T){const b=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let K=0;K<6;K++){if(Array.isArray(b.__webglFramebuffer[K]))for(let Z=0;Z<b.__webglFramebuffer[K].length;Z++)i.deleteFramebuffer(b.__webglFramebuffer[K][Z]);else i.deleteFramebuffer(b.__webglFramebuffer[K]);b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer[K])}else{if(Array.isArray(b.__webglFramebuffer))for(let K=0;K<b.__webglFramebuffer.length;K++)i.deleteFramebuffer(b.__webglFramebuffer[K]);else i.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&i.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let K=0;K<b.__webglColorRenderbuffer.length;K++)b.__webglColorRenderbuffer[K]&&i.deleteRenderbuffer(b.__webglColorRenderbuffer[K]);b.__webglDepthRenderbuffer&&i.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const L=T.textures;for(let K=0,Z=L.length;K<Z;K++){const X=n.get(L[K]);X.__webglTexture&&(i.deleteTexture(X.__webglTexture),r.memory.textures--),n.remove(L[K])}n.remove(T)}let R=0;function k(){R=0}function z(){const T=R;return T>=s.maxTextures&&Ee("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),R+=1,T}function W(T){const b=[];return b.push(T.wrapS),b.push(T.wrapT),b.push(T.wrapR||0),b.push(T.magFilter),b.push(T.minFilter),b.push(T.anisotropy),b.push(T.internalFormat),b.push(T.format),b.push(T.type),b.push(T.generateMipmaps),b.push(T.premultiplyAlpha),b.push(T.flipY),b.push(T.unpackAlignment),b.push(T.colorSpace),b.join()}function G(T,b){const L=n.get(T);if(T.isVideoTexture&&Ke(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&L.__version!==T.version){const K=T.image;if(K===null)Ee("WebGLRenderer: Texture marked for update but no image data found.");else if(K.complete===!1)Ee("WebGLRenderer: Texture marked for update but image is incomplete");else{q(L,T,b);return}}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+b)}function U(T,b){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){q(L,T,b);return}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+b)}function F(T,b){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){q(L,T,b);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+b)}function J(T,b){const L=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&L.__version!==T.version){ee(L,T,b);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+b)}const Y={[Bi]:i.REPEAT,[fn]:i.CLAMP_TO_EDGE,[ma]:i.MIRRORED_REPEAT},re={[_t]:i.NEAREST,[Pl]:i.NEAREST_MIPMAP_NEAREST,[us]:i.NEAREST_MIPMAP_LINEAR,[xt]:i.LINEAR,[ca]:i.LINEAR_MIPMAP_NEAREST,[Pn]:i.LINEAR_MIPMAP_LINEAR},ue={[Jh]:i.NEVER,[tu]:i.ALWAYS,[Zh]:i.LESS,[wo]:i.LEQUAL,[$h]:i.EQUAL,[Ro]:i.GEQUAL,[Qh]:i.GREATER,[eu]:i.NOTEQUAL};function he(T,b){if(b.type===Wt&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===xt||b.magFilter===ca||b.magFilter===us||b.magFilter===Pn||b.minFilter===xt||b.minFilter===ca||b.minFilter===us||b.minFilter===Pn)&&Ee("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,Y[b.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,Y[b.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,Y[b.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,re[b.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,re[b.minFilter]),b.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,ue[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===_t||b.minFilter!==us&&b.minFilter!==Pn||b.type===Wt&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function Ce(T,b){let L=!1;T.__webglInit===void 0&&(T.__webglInit=!0,b.addEventListener("dispose",w));const K=b.source;let Z=u.get(K);Z===void 0&&(Z={},u.set(K,Z));const X=W(b);if(X!==T.__cacheKey){Z[X]===void 0&&(Z[X]={texture:i.createTexture(),usedTimes:0},r.memory.textures++,L=!0),Z[X].usedTimes++;const me=Z[T.__cacheKey];me!==void 0&&(Z[T.__cacheKey].usedTimes--,me.usedTimes===0&&y(b)),T.__cacheKey=X,T.__webglTexture=Z[X].texture}return L}function Ye(T,b,L){return Math.floor(Math.floor(T/L)/b)}function je(T,b,L,K){const X=T.updateRanges;if(X.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,b.width,b.height,L,K,b.data);else{X.sort(($,te)=>$.start-te.start);let me=0;for(let $=1;$<X.length;$++){const te=X[me],ge=X[$],_e=te.start+te.count,de=Ye(ge.start,b.width,4),ze=Ye(te.start,b.width,4);ge.start<=_e+1&&de===ze&&Ye(ge.start+ge.count-1,b.width,4)===de?te.count=Math.max(te.count,ge.start+ge.count-te.start):(++me,X[me]=ge)}X.length=me+1;const ie=i.getParameter(i.UNPACK_ROW_LENGTH),Te=i.getParameter(i.UNPACK_SKIP_PIXELS),we=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,b.width);for(let $=0,te=X.length;$<te;$++){const ge=X[$],_e=Math.floor(ge.start/4),de=Math.ceil(ge.count/4),ze=_e%b.width,D=Math.floor(_e/b.width),se=de,ne=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,ze),i.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,ze,D,se,ne,L,K,b.data)}T.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ie),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Te),i.pixelStorei(i.UNPACK_SKIP_ROWS,we)}}function q(T,b,L){let K=i.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(K=i.TEXTURE_2D_ARRAY),b.isData3DTexture&&(K=i.TEXTURE_3D);const Z=Ce(T,b),X=b.source;t.bindTexture(K,T.__webglTexture,i.TEXTURE0+L);const me=n.get(X);if(X.version!==me.__version||Z===!0){t.activeTexture(i.TEXTURE0+L);const ie=We.getPrimaries(We.workingColorSpace),Te=b.colorSpace===Kn?null:We.getPrimaries(b.colorSpace),we=b.colorSpace===Kn||ie===Te?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);let $=v(b.image,!1,s.maxTextureSize);$=rt(b,$);const te=a.convert(b.format,b.colorSpace),ge=a.convert(b.type);let _e=E(b.internalFormat,te,ge,b.colorSpace,b.isVideoTexture);he(K,b);let de;const ze=b.mipmaps,D=b.isVideoTexture!==!0,se=me.__version===void 0||Z===!0,ne=X.dataReady,pe=A(b,$);if(b.isDepthTexture)_e=S(b.format===ci,b.type),se&&(D?t.texStorage2D(i.TEXTURE_2D,1,_e,$.width,$.height):t.texImage2D(i.TEXTURE_2D,0,_e,$.width,$.height,0,te,ge,null));else if(b.isDataTexture)if(ze.length>0){D&&se&&t.texStorage2D(i.TEXTURE_2D,pe,_e,ze[0].width,ze[0].height);for(let Q=0,j=ze.length;Q<j;Q++)de=ze[Q],D?ne&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,de.width,de.height,te,ge,de.data):t.texImage2D(i.TEXTURE_2D,Q,_e,de.width,de.height,0,te,ge,de.data);b.generateMipmaps=!1}else D?(se&&t.texStorage2D(i.TEXTURE_2D,pe,_e,$.width,$.height),ne&&je(b,$,te,ge)):t.texImage2D(i.TEXTURE_2D,0,_e,$.width,$.height,0,te,ge,$.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){D&&se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,_e,ze[0].width,ze[0].height,$.depth);for(let Q=0,j=ze.length;Q<j;Q++)if(de=ze[Q],b.format!==jt)if(te!==null)if(D){if(ne)if(b.layerUpdates.size>0){const be=Hc(de.width,de.height,b.format,b.type);for(const Ie of b.layerUpdates){const ot=de.data.subarray(Ie*be/de.data.BYTES_PER_ELEMENT,(Ie+1)*be/de.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,Ie,de.width,de.height,1,te,ot)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,de.width,de.height,$.depth,te,de.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,_e,de.width,de.height,$.depth,0,de.data,0,0);else Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?ne&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,de.width,de.height,$.depth,te,ge,de.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,_e,de.width,de.height,$.depth,0,te,ge,de.data)}else{D&&se&&t.texStorage2D(i.TEXTURE_2D,pe,_e,ze[0].width,ze[0].height);for(let Q=0,j=ze.length;Q<j;Q++)de=ze[Q],b.format!==jt?te!==null?D?ne&&t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,de.width,de.height,te,de.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,_e,de.width,de.height,0,de.data):Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?ne&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,de.width,de.height,te,ge,de.data):t.texImage2D(i.TEXTURE_2D,Q,_e,de.width,de.height,0,te,ge,de.data)}else if(b.isDataArrayTexture)if(D){if(se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,_e,$.width,$.height,$.depth),ne)if(b.layerUpdates.size>0){const Q=Hc($.width,$.height,b.format,b.type);for(const j of b.layerUpdates){const be=$.data.subarray(j*Q/$.data.BYTES_PER_ELEMENT,(j+1)*Q/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,j,$.width,$.height,1,te,ge,be)}b.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,te,ge,$.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,_e,$.width,$.height,$.depth,0,te,ge,$.data);else if(b.isData3DTexture)D?(se&&t.texStorage3D(i.TEXTURE_3D,pe,_e,$.width,$.height,$.depth),ne&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,te,ge,$.data)):t.texImage3D(i.TEXTURE_3D,0,_e,$.width,$.height,$.depth,0,te,ge,$.data);else if(b.isFramebufferTexture){if(se)if(D)t.texStorage2D(i.TEXTURE_2D,pe,_e,$.width,$.height);else{let Q=$.width,j=$.height;for(let be=0;be<pe;be++)t.texImage2D(i.TEXTURE_2D,be,_e,Q,j,0,te,ge,null),Q>>=1,j>>=1}}else if(ze.length>0){if(D&&se){const Q=ve(ze[0]);t.texStorage2D(i.TEXTURE_2D,pe,_e,Q.width,Q.height)}for(let Q=0,j=ze.length;Q<j;Q++)de=ze[Q],D?ne&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,te,ge,de):t.texImage2D(i.TEXTURE_2D,Q,_e,te,ge,de);b.generateMipmaps=!1}else if(D){if(se){const Q=ve($);t.texStorage2D(i.TEXTURE_2D,pe,_e,Q.width,Q.height)}ne&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,te,ge,$)}else t.texImage2D(i.TEXTURE_2D,0,_e,te,ge,$);g(b)&&f(K),me.__version=X.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function ee(T,b,L){if(b.image.length!==6)return;const K=Ce(T,b),Z=b.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+L);const X=n.get(Z);if(Z.version!==X.__version||K===!0){t.activeTexture(i.TEXTURE0+L);const me=We.getPrimaries(We.workingColorSpace),ie=b.colorSpace===Kn?null:We.getPrimaries(b.colorSpace),Te=b.colorSpace===Kn||me===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);const we=b.isCompressedTexture||b.image[0].isCompressedTexture,$=b.image[0]&&b.image[0].isDataTexture,te=[];for(let j=0;j<6;j++)!we&&!$?te[j]=v(b.image[j],!0,s.maxCubemapSize):te[j]=$?b.image[j].image:b.image[j],te[j]=rt(b,te[j]);const ge=te[0],_e=a.convert(b.format,b.colorSpace),de=a.convert(b.type),ze=E(b.internalFormat,_e,de,b.colorSpace),D=b.isVideoTexture!==!0,se=X.__version===void 0||K===!0,ne=Z.dataReady;let pe=A(b,ge);he(i.TEXTURE_CUBE_MAP,b);let Q;if(we){D&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,ze,ge.width,ge.height);for(let j=0;j<6;j++){Q=te[j].mipmaps;for(let be=0;be<Q.length;be++){const Ie=Q[be];b.format!==jt?_e!==null?D?ne&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,0,0,Ie.width,Ie.height,_e,Ie.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,ze,Ie.width,Ie.height,0,Ie.data):Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?ne&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,0,0,Ie.width,Ie.height,_e,de,Ie.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,ze,Ie.width,Ie.height,0,_e,de,Ie.data)}}}else{if(Q=b.mipmaps,D&&se){Q.length>0&&pe++;const j=ve(te[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,ze,j.width,j.height)}for(let j=0;j<6;j++)if($){D?ne&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,te[j].width,te[j].height,_e,de,te[j].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,ze,te[j].width,te[j].height,0,_e,de,te[j].data);for(let be=0;be<Q.length;be++){const ot=Q[be].image[j].image;D?ne&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,0,0,ot.width,ot.height,_e,de,ot.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,ze,ot.width,ot.height,0,_e,de,ot.data)}}else{D?ne&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,_e,de,te[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,ze,_e,de,te[j]);for(let be=0;be<Q.length;be++){const Ie=Q[be];D?ne&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,0,0,_e,de,Ie.image[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,ze,_e,de,Ie.image[j])}}}g(b)&&f(i.TEXTURE_CUBE_MAP),X.__version=Z.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function ae(T,b,L,K,Z,X){const me=a.convert(L.format,L.colorSpace),ie=a.convert(L.type),Te=E(L.internalFormat,me,ie,L.colorSpace),we=n.get(b),$=n.get(L);if($.__renderTarget=b,!we.__hasExternalTextures){const te=Math.max(1,b.width>>X),ge=Math.max(1,b.height>>X);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,X,Te,te,ge,b.depth,0,me,ie,null):t.texImage2D(Z,X,Te,te,ge,0,me,ie,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),mt(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,K,Z,$.__webglTexture,0,P(b)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,K,Z,$.__webglTexture,X),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ne(T,b,L){if(i.bindRenderbuffer(i.RENDERBUFFER,T),b.depthBuffer){const K=b.depthTexture,Z=K&&K.isDepthTexture?K.type:null,X=S(b.stencilBuffer,Z),me=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;mt(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(b),X,b.width,b.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(b),X,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,X,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,me,i.RENDERBUFFER,T)}else{const K=b.textures;for(let Z=0;Z<K.length;Z++){const X=K[Z],me=a.convert(X.format,X.colorSpace),ie=a.convert(X.type),Te=E(X.internalFormat,me,ie,X.colorSpace);mt(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(b),Te,b.width,b.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(b),Te,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,Te,b.width,b.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ae(T,b,L){const K=b.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(b.depthTexture);if(Z.__renderTarget=b,(!Z.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),K){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),Z.__webglTexture===void 0){Z.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),he(i.TEXTURE_CUBE_MAP,b.depthTexture);const we=a.convert(b.depthTexture.format),$=a.convert(b.depthTexture.type);let te;b.depthTexture.format===On?te=i.DEPTH_COMPONENT24:b.depthTexture.format===ci&&(te=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,te,b.width,b.height,0,we,$,null)}}else G(b.depthTexture,0);const X=Z.__webglTexture,me=P(b),ie=K?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,Te=b.depthTexture.format===ci?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(b.depthTexture.format===On)mt(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Te,ie,X,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,Te,ie,X,0);else if(b.depthTexture.format===ci)mt(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Te,ie,X,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,Te,ie,X,0);else throw new Error("Unknown depthTexture format")}function Le(T){const b=n.get(T),L=T.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==T.depthTexture){const K=T.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),K){const Z=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,K.removeEventListener("dispose",Z)};K.addEventListener("dispose",Z),b.__depthDisposeCallback=Z}b.__boundDepthTexture=K}if(T.depthTexture&&!b.__autoAllocateDepthBuffer)if(L)for(let K=0;K<6;K++)Ae(b.__webglFramebuffer[K],T,K);else{const K=T.texture.mipmaps;K&&K.length>0?Ae(b.__webglFramebuffer[0],T,0):Ae(b.__webglFramebuffer,T,0)}else if(L){b.__webglDepthbuffer=[];for(let K=0;K<6;K++)if(t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[K]),b.__webglDepthbuffer[K]===void 0)b.__webglDepthbuffer[K]=i.createRenderbuffer(),Ne(b.__webglDepthbuffer[K],T,!1);else{const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=b.__webglDepthbuffer[K];i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,X)}}else{const K=T.texture.mipmaps;if(K&&K.length>0?t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=i.createRenderbuffer(),Ne(b.__webglDepthbuffer,T,!1);else{const Z=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,X=b.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,X),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,X)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function St(T,b,L){const K=n.get(T);b!==void 0&&ae(K.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&Le(T)}function qe(T){const b=T.texture,L=n.get(T),K=n.get(b);T.addEventListener("dispose",C);const Z=T.textures,X=T.isWebGLCubeRenderTarget===!0,me=Z.length>1;if(me||(K.__webglTexture===void 0&&(K.__webglTexture=i.createTexture()),K.__version=b.version,r.memory.textures++),X){L.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(b.mipmaps&&b.mipmaps.length>0){L.__webglFramebuffer[ie]=[];for(let Te=0;Te<b.mipmaps.length;Te++)L.__webglFramebuffer[ie][Te]=i.createFramebuffer()}else L.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){L.__webglFramebuffer=[];for(let ie=0;ie<b.mipmaps.length;ie++)L.__webglFramebuffer[ie]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(me)for(let ie=0,Te=Z.length;ie<Te;ie++){const we=n.get(Z[ie]);we.__webglTexture===void 0&&(we.__webglTexture=i.createTexture(),r.memory.textures++)}if(T.samples>0&&mt(T)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ie=0;ie<Z.length;ie++){const Te=Z[ie];L.__webglColorRenderbuffer[ie]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[ie]);const we=a.convert(Te.format,Te.colorSpace),$=a.convert(Te.type),te=E(Te.internalFormat,we,$,Te.colorSpace,T.isXRRenderTarget===!0),ge=P(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,te,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,L.__webglColorRenderbuffer[ie])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),Ne(L.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(X){t.bindTexture(i.TEXTURE_CUBE_MAP,K.__webglTexture),he(i.TEXTURE_CUBE_MAP,b);for(let ie=0;ie<6;ie++)if(b.mipmaps&&b.mipmaps.length>0)for(let Te=0;Te<b.mipmaps.length;Te++)ae(L.__webglFramebuffer[ie][Te],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Te);else ae(L.__webglFramebuffer[ie],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);g(b)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(me){for(let ie=0,Te=Z.length;ie<Te;ie++){const we=Z[ie],$=n.get(we);let te=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(te=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(te,$.__webglTexture),he(te,we),ae(L.__webglFramebuffer,T,we,i.COLOR_ATTACHMENT0+ie,te,0),g(we)&&f(te)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ie=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,K.__webglTexture),he(ie,b),b.mipmaps&&b.mipmaps.length>0)for(let Te=0;Te<b.mipmaps.length;Te++)ae(L.__webglFramebuffer[Te],T,b,i.COLOR_ATTACHMENT0,ie,Te);else ae(L.__webglFramebuffer,T,b,i.COLOR_ATTACHMENT0,ie,0);g(b)&&f(ie),t.unbindTexture()}T.depthBuffer&&Le(T)}function Je(T){const b=T.textures;for(let L=0,K=b.length;L<K;L++){const Z=b[L];if(g(Z)){const X=x(T),me=n.get(Z).__webglTexture;t.bindTexture(X,me),f(X),t.unbindTexture()}}}const st=[],Be=[];function ut(T){if(T.samples>0){if(mt(T)===!1){const b=T.textures,L=T.width,K=T.height;let Z=i.COLOR_BUFFER_BIT;const X=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,me=n.get(T),ie=b.length>1;if(ie)for(let we=0;we<b.length;we++)t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,me.__webglMultisampledFramebuffer);const Te=T.texture.mipmaps;Te&&Te.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer);for(let we=0;we<b.length;we++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),ie){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,me.__webglColorRenderbuffer[we]);const $=n.get(b[we]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,$,0)}i.blitFramebuffer(0,0,L,K,0,0,L,K,Z,i.NEAREST),l===!0&&(st.length=0,Be.length=0,st.push(i.COLOR_ATTACHMENT0+we),T.depthBuffer&&T.resolveDepthBuffer===!1&&(st.push(X),Be.push(X),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Be)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,st))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ie)for(let we=0;we<b.length;we++){t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,me.__webglColorRenderbuffer[we]);const $=n.get(b[we]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,$,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const b=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[b])}}}function P(T){return Math.min(s.maxSamples,T.samples)}function mt(T){const b=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Ke(T){const b=r.render.frame;h.get(T)!==b&&(h.set(T,b),T.update())}function rt(T,b){const L=T.colorSpace,K=T.format,Z=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||L!==Ut&&L!==Kn&&(We.getTransfer(L)===$e?(K!==jt||Z!==Gt)&&Ee("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Re("WebGLTextures: Unsupported texture color space:",L)),b}function ve(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=z,this.resetTextureUnits=k,this.setTexture2D=G,this.setTexture2DArray=U,this.setTexture3D=F,this.setTextureCube=J,this.rebindTextures=St,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=Je,this.updateMultisampleRenderTarget=ut,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=mt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function yb(i,e){function t(n,s=Kn){let a;const r=We.getTransfer(s);if(n===Gt)return i.UNSIGNED_BYTE;if(n===vo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Mo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Il)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Fl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Dl)return i.BYTE;if(n===Ll)return i.SHORT;if(n===_s)return i.UNSIGNED_SHORT;if(n===xo)return i.INT;if(n===bn)return i.UNSIGNED_INT;if(n===Wt)return i.FLOAT;if(n===Un)return i.HALF_FLOAT;if(n===Nl)return i.ALPHA;if(n===Ul)return i.RGB;if(n===jt)return i.RGBA;if(n===On)return i.DEPTH_COMPONENT;if(n===ci)return i.DEPTH_STENCIL;if(n===So)return i.RED;if(n===Eo)return i.RED_INTEGER;if(n===zi)return i.RG;if(n===yo)return i.RG_INTEGER;if(n===To)return i.RGBA_INTEGER;if(n===la||n===ha||n===ua||n===da)if(r===$e)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(n===la)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ha)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ua)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===da)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(n===la)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ha)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ua)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===da)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Tr||n===Ar||n===wr||n===Rr)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(n===Tr)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ar)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===wr)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Rr)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Cr||n===Pr||n===Dr||n===Lr||n===Ir||n===Fr||n===Nr)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(n===Cr||n===Pr)return r===$e?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(n===Dr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(n===Lr)return a.COMPRESSED_R11_EAC;if(n===Ir)return a.COMPRESSED_SIGNED_R11_EAC;if(n===Fr)return a.COMPRESSED_RG11_EAC;if(n===Nr)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Ur||n===Or||n===kr||n===Br||n===zr||n===Gr||n===Vr||n===Hr||n===Wr||n===jr||n===qr||n===Xr||n===Kr||n===Yr)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(n===Ur)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Or)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===kr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Br)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===zr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Gr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Vr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Hr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Wr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===jr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===qr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Xr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Kr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Yr)return r===$e?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Jr||n===Zr||n===$r)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(n===Jr)return r===$e?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Zr)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===$r)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Qr||n===eo||n===to||n===no)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(n===Qr)return a.COMPRESSED_RED_RGTC1_EXT;if(n===eo)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===to)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===no)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===xs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Tb=`
void main() {
