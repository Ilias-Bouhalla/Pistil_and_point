...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function Wc(){return new _n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ma(),fragmentShader:`
		...
		`,blending:Ln,depthTest:!1,depthWrite:!1})}function jc(){return new _n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ma(),fragmentShader:`
...
`)+`
`+f);const E=v+g+r,S=v+f+o,A=$c(s,s.VERTEX_SHADER,E),w=$c(s,s.FRAGMENT_SHADER,S);s.attachShader(x,A),s.attachShader(x,w),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function C(R){if(i.debug.checkShaderErrors){const B=s.getProgramInfoLog(x)||"",V=s.getShaderInfoLog(A)||"",z=s.getShaderInfoLog(w)||"",O=B.trim(),U=V.trim(),I=z.trim();let Z=!0,J=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(Z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,x,A,w);else{const ce=el(s,A,"vertex"),ue=el(s,w,"fragment");Re("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,bb=[new F(1,0,0),new F(-1,0,0),new F(0,1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1)],_b=[new F(0,-1,0),new F(0,-1,0),new F(0,0,1),new F(0,0,-1),new F(0,-1,0),new F(0,-1,0)],cl=new ke,ss=new F,rr=new F;function xb(i,e,t){let n=new Co;const s=new Pe,a=new Pe,r=new ot,o=new id,l=new sd,c={},h=t.maxTextureSize,d={[Fn]:Ut,[Ut]:Fn,[un]:un},u=new _n({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Pe},radius:{value:4}},vertexShader:mb,fragmentShader:gb}),p=u.clone();p.defines.HORIZONTAL_PASS=1;const m=new qt;m.setAttribute("position",new It(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const x=new Ot(m,u),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=sa;let f=this.type;this.render=function(w,C,_){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||w.length===0)return;this.type===xl&&(Ee("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=sa);const y=i.getRenderTarget(),W=i.getActiveCubeFace(),R=i.getActiveMipmapLevel(),B=i.state;B.setBlending(Ln),B.buffers.depth.getReversed()===!0?B.buffers.color.setClear(0,0,0,0):B.buffers.color.setClear(1,1,1,1),B.buffers.depth.setTest(!0),B.setScissorTest(!1);const V=f!==this.type;V&&C.traverse(function(z){z.material&&(Array.isArray(z.material)?z.material.forEach(O=>O.needsUpdate=!0):z.material.needsUpdate=!0)});for(let z=0,O=w.length;z<O;z++){const U=w[z],I=U.shadow;if(I===void 0){Ee("WebGLShadowMap:",U,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;s.copy(I.mapSize);const Z=I.getFrameExtents();s.multiply(Z),a.copy(I.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(a.x=Math.floor(h/Z.x),s.x=a.x*Z.x,I.mapSize.x=a.x),s.y>h&&(a.y=Math.floor(h/Z.y),s.y=a.y*Z.y,I.mapSize.y=a.y));const J=i.state.buffers.depth.getReversed();if(I.camera._reversedDepth=J,I.map===null||V===!0){if(I.map!==null&&(I.map.depthTexture!==null&&(I.map.depthTexture.dispose(),I.map.depthTexture=null),I.map.dispose()),this.type===cs){if(U.isPointLight){Ee("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}I.map=new mn(s.x,s.y,{format:Bi,type:Nn,minFilter:_t,magFilter:_t,generateMipmaps:!1}),I.map.texture.name=U.name+".shadowMap",I.map.depthTexture=new Ss(s.x,s.y,Wt),I.map.depthTexture.name=U.name+".shadowMapDepth",I.map.depthTexture.format=Un,I.map.depthTexture.compareFunction=null,I.map.depthTexture.minFilter=bt,I.map.depthTexture.magFilter=bt}else U.isPointLight?(I.map=new th(s.x),I.map.depthTexture=new Ju(s.x,gn)):(I.map=new mn(s.x,s.y),I.map.depthTexture=new Ss(s.x,s.y,gn)),I.map.depthTexture.name=U.name+".shadowMap",I.map.depthTexture.format=Un,this.type===sa?(I.map.depthTexture.compareFunction=J?Eo:So,I.map.depthTexture.minFilter=_t,I.map.depthTexture.magFilter=_t):(I.map.depthTexture.compareFunction=null,I.map.depthTexture.minFilter=bt,I.map.depthTexture.magFilter=bt);I.camera.updateProjectionMatrix()}const ce=I.map.isWebGLCubeRenderTarget?6:1;for(let ue=0;ue<ce;ue++){if(I.map.isWebGLCubeRenderTarget)i.setRenderTarget(I.map,ue),i.clear();else{ue===0&&(i.setRenderTarget(I.map),i.clear());const oe=I.getViewport(ue);r.set(a.x*oe.x,a.y*oe.y,a.x*oe.z,a.y*oe.w),B.viewport(r)}if(U.isPointLight){const oe=I.camera,De=I.matrix,ct=U.distance||oe.far;ct!==oe.far&&(oe.far=ct,oe.updateProjectionMatrix()),ss.setFromMatrixPosition(U.matrixWorld),oe.position.copy(ss),rr.copy(oe.position),rr.add(bb[ue]),oe.up.copy(_b[ue]),oe.lookAt(rr),oe.updateMatrixWorld(),De.makeTranslation(-ss.x,-ss.y,-ss.z),cl.multiplyMatrices(oe.projectionMatrix,oe.matrixWorldInverse),I._frustum.setFromProjectionMatrix(cl,oe.coordinateSystem,oe.reversedDepth)}else I.updateMatrices(U);n=I.getFrustum(),S(C,_,I.camera,U,this.type)}I.isPointLightShadow!==!0&&this.type===cs&&v(I,_),I.needsUpdate=!1}f=this.type,g.needsUpdate=!1,i.setRenderTarget(y,W,R)};function v(w,C){const _=e.update(x);u.defines.VSM_SAMPLES!==w.blurSamples&&(u.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new mn(s.x,s.y,{format:Bi,type:Nn})),u.uniforms.shadow_pass.value=w.map.depthTexture,u.uniforms.resolution.value=w.mapSize,u.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(C,null,_,u,x,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(C,null,_,p,x,null)}function E(w,C,_,y){let W=null;const R=_.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(R!==void 0)W=R;else if(W=_.isPointLight===!0?l:o,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const B=W.uuid,V=C.uuid;let z=c[B];z===void 0&&(z={},c[B]=z);let O=z[V];O===void 0&&(O=W.clone(),z[V]=O,C.addEventListener("dispose",A)),W=O}if(W.visible=C.visible,W.wireframe=C.wireframe,y===cs?W.side=C.shadowSide!==null?C.shadowSide:C.side:W.side=C.shadowSide!==null?C.shadowSide:d[C.side],W.alphaMap=C.alphaMap,W.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,W.map=C.map,W.clipShadows=C.clipShadows,W.clippingPlanes=C.clippingPlanes,W.clipIntersection=C.clipIntersection,W.displacementMap=C.displacementMap,W.displacementScale=C.displacementScale,W.displacementBias=C.displacementBias,W.wireframeLinewidth=C.wireframeLinewidth,W.linewidth=C.linewidth,_.isPointLight===!0&&W.isMeshDistanceMaterial===!0){const B=i.properties.get(W);B.light=_}return W}function S(w,C,_,y,W){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&W===cs)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(_.matrixWorldInverse,w.matrixWorld);const V=e.update(w),z=w.material;if(Array.isArray(z)){const O=V.groups;for(let U=0,I=O.length;U<I;U++){const Z=O[U],J=z[Z.materialIndex];if(J&&J.visible){const ce=E(w,J,y,W);w.onBeforeShadow(i,w,C,_,V,ce,Z),i.renderBufferDirect(_,null,V,ce,w,Z),w.onAfterShadow(i,w,C,_,V,ce,Z)}}}else if(z.visible){const O=E(w,z,y,W);w.onBeforeShadow(i,w,C,_,V,O,null),i.renderBufferDirect(_,null,V,O,w,null),w.onAfterShadow(i,w,C,_,V,O,null)}}const B=w.children;for(let V=0,z=B.length;V<z;V++)S(B[V],C,_,y,W)}function A(w){w.target.removeEventListener("dispose",A);for(const _ in c){const y=c[_],W=w.target.uuid;W in y&&(y[W].dispose(),delete y[W])}}}function vb(i,e){function t(){let D=!1;const se=new ot;let te=null;const pe=new ot(0,0,0,0);return{setMask:function(Q){te!==Q&&!D&&(i.colorMask(Q,Q,Q,Q),te=Q)},setLocked:function(Q){D=Q},setClear:function(Q,j,be,Le,at){at===!0&&(Q*=Le,j*=Le,be*=Le),se.set(Q,j,be,Le),pe.equals(se)===!1&&(i.clearColor(Q,j,be,Le),pe.copy(se))},reset:function(){D=!1,te=null,pe.set(-1,0,0,0)}}}function n(){let D=!1,se=!1,te=null,pe=null,Q=null;return{setReversed:function(j){if(se!==j){const be=e.get("EXT_clip_control");j?be.clipControlEXT(be.LOWER_LEFT_EXT,be.ZERO_TO_ONE_EXT):be.clipControlEXT(be.LOWER_LEFT_EXT,be.NEGATIVE_ONE_TO_ONE_EXT),se=j;const Le=Q;Q=null,this.setClear(Le)}},getReversed:function(){return se},setTest:function(j){j?ne(i.DEPTH_TEST):ae(i.DEPTH_TEST)},setMask:function(j){te!==j&&!D&&(i.depthMask(j),te=j)},setFunc:function(j){if(se&&(j=nu[j]),pe!==j){switch(j){case gr:i.depthFunc(i.NEVER);break;case br:i.depthFunc(i.ALWAYS);break;case _r:i.depthFunc(i.LESS);break;case Ui:i.depthFunc(i.LEQUAL);break;case xr:i.depthFunc(i.EQUAL);break;case vr:i.depthFunc(i.GEQUAL);break;case Mr:i.depthFunc(i.GREATER);break;case Sr:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}pe=j}},setLocked:function(j){D=j},setClear:function(j){Q!==j&&(Q=j,se&&(j=1-j),i.clearDepth(j))},reset:function(){D=!1,te=null,pe=null,Q=null,se=!1}}}function s(){let D=!1,se=null,te=null,pe=null,Q=null,j=null,be=null,Le=null,at=null;return{setTest:function(Ye){D||(Ye?ne(i.STENCIL_TEST):ae(i.STENCIL_TEST))},setMask:function(Ye){se!==Ye&&!D&&(i.stencilMask(Ye),se=Ye)},setFunc:function(Ye,Sn,En){(te!==Ye||pe!==Sn||Q!==En)&&(i.stencilFunc(Ye,Sn,En),te=Ye,pe=Sn,Q=En)},setOp:function(Ye,Sn,En){(j!==Ye||be!==Sn||Le!==En)&&(i.stencilOp(Ye,Sn,En),j=Ye,be=Sn,Le=En)},setLocked:function(Ye){D=Ye},setClear:function(Ye){at!==Ye&&(i.clearStencil(Ye),at=Ye)},reset:function(){D=!1,se=null,te=null,pe=null,Q=null,j=null,be=null,Le=null,at=null}}}const a=new t,r=new n,o=new s,l=new WeakMap,c=new WeakMap;let h={},d={},u=new WeakMap,p=[],m=null,x=!1,g=null,f=null,v=null,E=null,S=null,A=null,w=null,C=new Ie(0,0,0),_=0,y=!1,W=null,R=null,B=null,V=null,z=null;const O=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let U=!1,I=0;const Z=i.getParameter(i.VERSION);Z.indexOf("WebGL")!==-1?(I=parseFloat(/^WebGL (\d)/.exec(Z)[1]),U=I>=1):Z.indexOf("OpenGL ES")!==-1&&(I=parseFloat(/^OpenGL ES (\d)/.exec(Z)[1]),U=I>=2);let J=null,ce={};const ue=i.getParameter(i.SCISSOR_BOX),oe=i.getParameter(i.VIEWPORT),De=new ot().fromArray(ue),ct=new ot().fromArray(oe);function rt(D,se,te,pe){const Q=new Uint8Array(4),j=i.createTexture();i.bindTexture(D,j),i.texParameteri(D,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(D,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let be=0;be<te;be++)D===i.TEXTURE_3D||D===i.TEXTURE_2D_ARRAY?i.texImage3D(se,0,i.RGBA,1,1,pe,0,i.RGBA,i.UNSIGNED_BYTE,Q):i.texImage2D(se+be,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,Q);return j}const K={};K[i.TEXTURE_2D]=rt(i.TEXTURE_2D,i.TEXTURE_2D,1),K[i.TEXTURE_CUBE_MAP]=rt(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[i.TEXTURE_2D_ARRAY]=rt(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),K[i.TEXTURE_3D]=rt(i.TEXTURE_3D,i.TEXTURE_3D,1,1),a.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ne(i.DEPTH_TEST),r.setFunc(Ui),Be(!1),ut(jo),ne(i.CULL_FACE),Ke(Ln);function ne(D){h[D]!==!0&&(i.enable(D),h[D]=!0)}function ae(D){h[D]!==!1&&(i.disable(D),h[D]=!1)}function Ne(D,se){return d[D]!==se?(i.bindFramebuffer(D,se),d[D]=se,D===i.DRAW_FRAMEBUFFER&&(d[i.FRAMEBUFFER]=se),D===i.FRAMEBUFFER&&(d[i.DRAW_FRAMEBUFFER]=se),!0):!1}function Ae(D,se){let te=p,pe=!1;if(D){te=u.get(se),te===void 0&&(te=[],u.set(se,te));const Q=D.textures;if(te.length!==Q.length||te[0]!==i.COLOR_ATTACHMENT0){for(let j=0,be=Q.length;j<be;j++)te[j]=i.COLOR_ATTACHMENT0+j;te.length=Q.length,pe=!0}}else te[0]!==i.BACK&&(te[0]=i.BACK,pe=!0);pe&&i.drawBuffers(te)}function Ce(D){return m!==D?(i.useProgram(D),m=D,!0):!1}const Mt={[ri]:i.FUNC_ADD,[Sh]:i.FUNC_SUBTRACT,[Eh]:i.FUNC_REVERSE_SUBTRACT};Mt[yh]=i.MIN,Mt[Th]=i.MAX;const je={[Ah]:i.ZERO,[wh]:i.ONE,[Rh]:i.SRC_COLOR,[pr]:i.SRC_ALPHA,[Fh]:i.SRC_ALPHA_SATURATE,[Lh]:i.DST_COLOR,[Ph]:i.DST_ALPHA,[Ch]:i.ONE_MINUS_SRC_COLOR,[mr]:i.ONE_MINUS_SRC_ALPHA,[Ih]:i.ONE_MINUS_DST_COLOR,[Dh]:i.ONE_MINUS_DST_ALPHA,[Nh]:i.CONSTANT_COLOR,[Uh]:i.ONE_MINUS_CONSTANT_COLOR,[Oh]:i.CONSTANT_ALPHA,[kh]:i.ONE_MINUS_CONSTANT_ALPHA};function Ke(D,se,te,pe,Q,j,be,Le,at,Ye){if(D===Ln){x===!0&&(ae(i.BLEND),x=!1);return}if(x===!1&&(ne(i.BLEND),x=!0),D!==Mh){if(D!==g||Ye!==y){if((f!==ri||S!==ri)&&(i.blendEquation(i.FUNC_ADD),f=ri,S=ri),Ye)switch(D){case Ii:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case qo:i.blendFunc(i.ONE,i.ONE);break;case Xo:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Ko:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:Re("WebGLState: Invalid blending: ",D);break}else switch(D){case Ii:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case qo:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Xo:Re("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ko:Re("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Re("WebGLState: Invalid blending: ",D);break}v=null,E=null,A=null,w=null,C.set(0,0,0),_=0,g=D,y=Ye}return}Q=Q||se,j=j||te,be=be||pe,(se!==f||Q!==S)&&(i.blendEquationSeparate(Mt[se],Mt[Q]),f=se,S=Q),(te!==v||pe!==E||j!==A||be!==w)&&(i.blendFuncSeparate(je[te],je[pe],je[j],je[be]),v=te,E=pe,A=j,w=be),(Le.equals(C)===!1||at!==_)&&(i.blendColor(Le.r,Le.g,Le.b,at),C.copy(Le),_=at),g=D,y=!1}function nt(D,se){D.side===un?ae(i.CULL_FACE):ne(i.CULL_FACE);let te=D.side===Ut;se&&(te=!te),Be(te),D.blending===Ii&&D.transparent===!1?Ke(Ln):Ke(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),r.setFunc(D.depthFunc),r.setTest(D.depthTest),r.setMask(D.depthWrite),a.setMask(D.colorWrite);const pe=D.stencilWrite;o.setTest(pe),pe&&(o.setMask(D.stencilWriteMask),o.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),o.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),pt(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ne(i.SAMPLE_ALPHA_TO_COVERAGE):ae(i.SAMPLE_ALPHA_TO_COVERAGE)}function Be(D){W!==D&&(D?i.frontFace(i.CW):i.frontFace(i.CCW),W=D)}function ut(D){D!==xh?(ne(i.CULL_FACE),D!==R&&(D===jo?i.cullFace(i.BACK):D===vh?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ae(i.CULL_FACE),R=D}function P(D){D!==B&&(U&&i.lineWidth(D),B=D)}function pt(D,se,te){D?(ne(i.POLYGON_OFFSET_FILL),(V!==se||z!==te)&&(V=se,z=te,r.getReversed()&&(se=-se),i.polygonOffset(se,te))):ae(i.POLYGON_OFFSET_FILL)}function Xe(D){D?ne(i.SCISSOR_TEST):ae(i.SCISSOR_TEST)}function st(D){D===void 0&&(D=i.TEXTURE0+O-1),J!==D&&(i.activeTexture(D),J=D)}function ve(D,se,te){te===void 0&&(J===null?te=i.TEXTURE0+O-1:te=J);let pe=ce[te];pe===void 0&&(pe={type:void 0,texture:void 0},ce[te]=pe),(pe.type!==D||pe.texture!==se)&&(J!==te&&(i.activeTexture(te),J=te),i.bindTexture(D,se||K[D]),pe.type=D,pe.texture=se)}function T(){const D=ce[J];D!==void 0&&D.type!==void 0&&(i.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function b(){try{i.compressedTexImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function L(){try{i.compressedTexImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function X(){try{i.texSubImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function Y(){try{i.texSubImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function me(){try{i.compressedTexSubImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function ie(){try{i.texStorage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function Te(){try{i.texStorage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function we(){try{i.texImage2D(...arguments)}catch(D){Re("WebGLState:",D)}}function $(){try{i.texImage3D(...arguments)}catch(D){Re("WebGLState:",D)}}function ee(D){De.equals(D)===!1&&(i.scissor(D.x,D.y,D.z,D.w),De.copy(D))}function ge(D){ct.equals(D)===!1&&(i.viewport(D.x,D.y,D.z,D.w),ct.copy(D))}function _e(D,se){let te=c.get(se);te===void 0&&(te=new WeakMap,c.set(se,te));let pe=te.get(D);pe===void 0&&(pe=i.getUniformBlockIndex(se,D.name),te.set(D,pe))}function de(D,se){const pe=c.get(se).get(D);l.get(se)!==pe&&(i.uniformBlockBinding(se,pe,D.__bindingPointIndex),l.set(se,pe))}function ze(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),r.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),h={},J=null,ce={},d={},u=new WeakMap,p=[],m=null,x=!1,g=null,f=null,v=null,E=null,S=null,A=null,w=null,C=new Ie(0,0,0),_=0,y=!1,W=null,R=null,B=null,V=null,z=null,De.set(0,0,i.canvas.width,i.canvas.height),ct.set(0,0,i.canvas.width,i.canvas.height),a.reset(),r.reset(),o.reset()}return{buffers:{color:a,depth:r,stencil:o},enable:ne,disable:ae,bindFramebuffer:Ne,drawBuffers:Ae,useProgram:Ce,setBlending:Ke,setMaterial:nt,setFlipSided:Be,setCullFace:ut,setLineWidth:P,setPolygonOffset:pt,setScissorTest:Xe,activeTexture:st,bindTexture:ve,unbindTexture:T,compressedTexImage2D:b,compressedTexImage3D:L,texImage2D:we,texImage3D:$,updateUBOMapping:_e,uniformBlockBinding:de,texStorage2D:ie,texStorage3D:Te,texSubImage2D:X,texSubImage3D:Y,compressedTexSubImage2D:q,compressedTexSubImage3D:me,scissor:ee,viewport:ge,reset:ze}}function Mb(i,e,t,n,s,a,r){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Pe,h=new WeakMap;let d;const u=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function m(T,b){return p?new OffscreenCanvas(T,b):Ms("canvas")}function x(T,b,L){let X=1;const Y=ve(T);if((Y.width>L||Y.height>L)&&(X=L/Math.max(Y.width,Y.height)),X<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const q=Math.floor(X*Y.width),me=Math.floor(X*Y.height);d===void 0&&(d=m(q,me));const ie=b?m(q,me):d;return ie.width=q,ie.height=me,ie.getContext("2d").drawImage(T,0,0,q,me),Ee("WebGLRenderer: Texture has been resized from ("+Y.width+"x"+Y.height+") to ("+q+"x"+me+")."),ie}else return"data"in T&&Ee("WebGLRenderer: Image in DataTexture is too big ("+Y.width+"x"+Y.height+")."),T;return T}function g(T){return T.generateMipmaps}function f(T){i.generateMipmap(T)}function v(T){return T.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?i.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(T,b,L,X,Y=!1){if(T!==null){if(i[T]!==void 0)return i[T];Ee("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let q=b;if(b===i.RED&&(L===i.FLOAT&&(q=i.R32F),L===i.HALF_FLOAT&&(q=i.R16F),L===i.UNSIGNED_BYTE&&(q=i.R8)),b===i.RED_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.R8UI),L===i.UNSIGNED_SHORT&&(q=i.R16UI),L===i.UNSIGNED_INT&&(q=i.R32UI),L===i.BYTE&&(q=i.R8I),L===i.SHORT&&(q=i.R16I),L===i.INT&&(q=i.R32I)),b===i.RG&&(L===i.FLOAT&&(q=i.RG32F),L===i.HALF_FLOAT&&(q=i.RG16F),L===i.UNSIGNED_BYTE&&(q=i.RG8)),b===i.RG_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RG8UI),L===i.UNSIGNED_SHORT&&(q=i.RG16UI),L===i.UNSIGNED_INT&&(q=i.RG32UI),L===i.BYTE&&(q=i.RG8I),L===i.SHORT&&(q=i.RG16I),L===i.INT&&(q=i.RG32I)),b===i.RGB_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RGB8UI),L===i.UNSIGNED_SHORT&&(q=i.RGB16UI),L===i.UNSIGNED_INT&&(q=i.RGB32UI),L===i.BYTE&&(q=i.RGB8I),L===i.SHORT&&(q=i.RGB16I),L===i.INT&&(q=i.RGB32I)),b===i.RGBA_INTEGER&&(L===i.UNSIGNED_BYTE&&(q=i.RGBA8UI),L===i.UNSIGNED_SHORT&&(q=i.RGBA16UI),L===i.UNSIGNED_INT&&(q=i.RGBA32UI),L===i.BYTE&&(q=i.RGBA8I),L===i.SHORT&&(q=i.RGBA16I),L===i.INT&&(q=i.RGBA32I)),b===i.RGB&&(L===i.UNSIGNED_INT_5_9_9_9_REV&&(q=i.RGB9_E5),L===i.UNSIGNED_INT_10F_11F_11F_REV&&(q=i.R11F_G11F_B10F)),b===i.RGBA){const me=Y?fa:We.getTransfer(X);L===i.FLOAT&&(q=i.RGBA32F),L===i.HALF_FLOAT&&(q=i.RGBA16F),L===i.UNSIGNED_BYTE&&(q=me===Je?i.SRGB8_ALPHA8:i.RGBA8),L===i.UNSIGNED_SHORT_4_4_4_4&&(q=i.RGBA4),L===i.UNSIGNED_SHORT_5_5_5_1&&(q=i.RGB5_A1)}return(q===i.R16F||q===i.R32F||q===i.RG16F||q===i.RG32F||q===i.RGBA16F||q===i.RGBA32F)&&e.get("EXT_color_buffer_float"),q}function S(T,b){let L;return T?b===null||b===gn||b===bs?L=i.DEPTH24_STENCIL8:b===Wt?L=i.DEPTH32F_STENCIL8:b===gs&&(L=i.DEPTH24_STENCIL8,Ee("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===gn||b===bs?L=i.DEPTH_COMPONENT24:b===Wt?L=i.DEPTH_COMPONENT32F:b===gs&&(L=i.DEPTH_COMPONENT16),L}function A(T,b){return g(T)===!0||T.isFramebufferTexture&&T.minFilter!==bt&&T.minFilter!==_t?Math.log2(Math.max(b.width,b.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?b.mipmaps.length:1}function w(T){const b=T.target;b.removeEventListener("dispose",w),_(b),b.isVideoTexture&&h.delete(b)}function C(T){const b=T.target;b.removeEventListener("dispose",C),W(b)}function _(T){const b=n.get(T);if(b.__webglInit===void 0)return;const L=T.source,X=u.get(L);if(X){const Y=X[b.__cacheKey];Y.usedTimes--,Y.usedTimes===0&&y(T),Object.keys(X).length===0&&u.delete(L)}n.remove(T)}function y(T){const b=n.get(T);i.deleteTexture(b.__webglTexture);const L=T.source,X=u.get(L);delete X[b.__cacheKey],r.memory.textures--}function W(T){const b=n.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),n.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(b.__webglFramebuffer[X]))for(let Y=0;Y<b.__webglFramebuffer[X].length;Y++)i.deleteFramebuffer(b.__webglFramebuffer[X][Y]);else i.deleteFramebuffer(b.__webglFramebuffer[X]);b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer[X])}else{if(Array.isArray(b.__webglFramebuffer))for(let X=0;X<b.__webglFramebuffer.length;X++)i.deleteFramebuffer(b.__webglFramebuffer[X]);else i.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&i.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&i.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let X=0;X<b.__webglColorRenderbuffer.length;X++)b.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(b.__webglColorRenderbuffer[X]);b.__webglDepthRenderbuffer&&i.deleteRenderbuffer(b.__webglDepthRenderbuffer)}const L=T.textures;for(let X=0,Y=L.length;X<Y;X++){const q=n.get(L[X]);q.__webglTexture&&(i.deleteTexture(q.__webglTexture),r.memory.textures--),n.remove(L[X])}n.remove(T)}let R=0;function B(){R=0}function V(){const T=R;return T>=s.maxTextures&&Ee("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+s.maxTextures),R+=1,T}function z(T){const b=[];return b.push(T.wrapS),b.push(T.wrapT),b.push(T.wrapR||0),b.push(T.magFilter),b.push(T.minFilter),b.push(T.anisotropy),b.push(T.internalFormat),b.push(T.format),b.push(T.type),b.push(T.generateMipmaps),b.push(T.premultiplyAlpha),b.push(T.flipY),b.push(T.unpackAlignment),b.push(T.colorSpace),b.join()}function O(T,b){const L=n.get(T);if(T.isVideoTexture&&Xe(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&L.__version!==T.version){const X=T.image;if(X===null)Ee("WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)Ee("WebGLRenderer: Texture marked for update but image is incomplete");else{K(L,T,b);return}}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,L.__webglTexture,i.TEXTURE0+b)}function U(T,b){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){K(L,T,b);return}else T.isExternalTexture&&(L.__webglTexture=T.sourceTexture?T.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,L.__webglTexture,i.TEXTURE0+b)}function I(T,b){const L=n.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&L.__version!==T.version){K(L,T,b);return}t.bindTexture(i.TEXTURE_3D,L.__webglTexture,i.TEXTURE0+b)}function Z(T,b){const L=n.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&L.__version!==T.version){ne(L,T,b);return}t.bindTexture(i.TEXTURE_CUBE_MAP,L.__webglTexture,i.TEXTURE0+b)}const J={[ki]:i.REPEAT,[dn]:i.CLAMP_TO_EDGE,[da]:i.MIRRORED_REPEAT},ce={[bt]:i.NEAREST,[Rl]:i.NEAREST_MIPMAP_NEAREST,[ls]:i.NEAREST_MIPMAP_LINEAR,[_t]:i.LINEAR,[aa]:i.LINEAR_MIPMAP_NEAREST,[Pn]:i.LINEAR_MIPMAP_LINEAR},ue={[qh]:i.NEVER,[Zh]:i.ALWAYS,[Xh]:i.LESS,[So]:i.LEQUAL,[Kh]:i.EQUAL,[Eo]:i.GEQUAL,[Yh]:i.GREATER,[Jh]:i.NOTEQUAL};function oe(T,b){if(b.type===Wt&&e.has("OES_texture_float_linear")===!1&&(b.magFilter===_t||b.magFilter===aa||b.magFilter===ls||b.magFilter===Pn||b.minFilter===_t||b.minFilter===aa||b.minFilter===ls||b.minFilter===Pn)&&Ee("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(T,i.TEXTURE_WRAP_S,J[b.wrapS]),i.texParameteri(T,i.TEXTURE_WRAP_T,J[b.wrapT]),(T===i.TEXTURE_3D||T===i.TEXTURE_2D_ARRAY)&&i.texParameteri(T,i.TEXTURE_WRAP_R,J[b.wrapR]),i.texParameteri(T,i.TEXTURE_MAG_FILTER,ce[b.magFilter]),i.texParameteri(T,i.TEXTURE_MIN_FILTER,ce[b.minFilter]),b.compareFunction&&(i.texParameteri(T,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(T,i.TEXTURE_COMPARE_FUNC,ue[b.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===bt||b.minFilter!==ls&&b.minFilter!==Pn||b.type===Wt&&e.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||n.get(b).__currentAnisotropy){const L=e.get("EXT_texture_filter_anisotropic");i.texParameterf(T,L.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),n.get(b).__currentAnisotropy=b.anisotropy}}}function De(T,b){let L=!1;T.__webglInit===void 0&&(T.__webglInit=!0,b.addEventListener("dispose",w));const X=b.source;let Y=u.get(X);Y===void 0&&(Y={},u.set(X,Y));const q=z(b);if(q!==T.__cacheKey){Y[q]===void 0&&(Y[q]={texture:i.createTexture(),usedTimes:0},r.memory.textures++,L=!0),Y[q].usedTimes++;const me=Y[T.__cacheKey];me!==void 0&&(Y[T.__cacheKey].usedTimes--,me.usedTimes===0&&y(b)),T.__cacheKey=q,T.__webglTexture=Y[q].texture}return L}function ct(T,b,L){return Math.floor(Math.floor(T/L)/b)}function rt(T,b,L,X){const q=T.updateRanges;if(q.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,b.width,b.height,L,X,b.data);else{q.sort(($,ee)=>$.start-ee.start);let me=0;for(let $=1;$<q.length;$++){const ee=q[me],ge=q[$],_e=ee.start+ee.count,de=ct(ge.start,b.width,4),ze=ct(ee.start,b.width,4);ge.start<=_e+1&&de===ze&&ct(ge.start+ge.count-1,b.width,4)===de?ee.count=Math.max(ee.count,ge.start+ge.count-ee.start):(++me,q[me]=ge)}q.length=me+1;const ie=i.getParameter(i.UNPACK_ROW_LENGTH),Te=i.getParameter(i.UNPACK_SKIP_PIXELS),we=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,b.width);for(let $=0,ee=q.length;$<ee;$++){const ge=q[$],_e=Math.floor(ge.start/4),de=Math.ceil(ge.count/4),ze=_e%b.width,D=Math.floor(_e/b.width),se=de,te=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,ze),i.pixelStorei(i.UNPACK_SKIP_ROWS,D),t.texSubImage2D(i.TEXTURE_2D,0,ze,D,se,te,L,X,b.data)}T.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,ie),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Te),i.pixelStorei(i.UNPACK_SKIP_ROWS,we)}}function K(T,b,L){let X=i.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),b.isData3DTexture&&(X=i.TEXTURE_3D);const Y=De(T,b),q=b.source;t.bindTexture(X,T.__webglTexture,i.TEXTURE0+L);const me=n.get(q);if(q.version!==me.__version||Y===!0){t.activeTexture(i.TEXTURE0+L);const ie=We.getPrimaries(We.workingColorSpace),Te=b.colorSpace===Xn?null:We.getPrimaries(b.colorSpace),we=b.colorSpace===Xn||ie===Te?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);let $=x(b.image,!1,s.maxTextureSize);$=st(b,$);const ee=a.convert(b.format,b.colorSpace),ge=a.convert(b.type);let _e=E(b.internalFormat,ee,ge,b.colorSpace,b.isVideoTexture);oe(X,b);let de;const ze=b.mipmaps,D=b.isVideoTexture!==!0,se=me.__version===void 0||Y===!0,te=q.dataReady,pe=A(b,$);if(b.isDepthTexture)_e=S(b.format===ci,b.type),se&&(D?t.texStorage2D(i.TEXTURE_2D,1,_e,$.width,$.height):t.texImage2D(i.TEXTURE_2D,0,_e,$.width,$.height,0,ee,ge,null));else if(b.isDataTexture)if(ze.length>0){D&&se&&t.texStorage2D(i.TEXTURE_2D,pe,_e,ze[0].width,ze[0].height);for(let Q=0,j=ze.length;Q<j;Q++)de=ze[Q],D?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,de.width,de.height,ee,ge,de.data):t.texImage2D(i.TEXTURE_2D,Q,_e,de.width,de.height,0,ee,ge,de.data);b.generateMipmaps=!1}else D?(se&&t.texStorage2D(i.TEXTURE_2D,pe,_e,$.width,$.height),te&&rt(b,$,ee,ge)):t.texImage2D(i.TEXTURE_2D,0,_e,$.width,$.height,0,ee,ge,$.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){D&&se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,_e,ze[0].width,ze[0].height,$.depth);for(let Q=0,j=ze.length;Q<j;Q++)if(de=ze[Q],b.format!==jt)if(ee!==null)if(D){if(te)if(b.layerUpdates.size>0){const be=Bc(de.width,de.height,b.format,b.type);for(const Le of b.layerUpdates){const at=de.data.subarray(Le*be/de.data.BYTES_PER_ELEMENT,(Le+1)*be/de.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,Le,de.width,de.height,1,ee,at)}b.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,de.width,de.height,$.depth,ee,de.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,Q,_e,de.width,de.height,$.depth,0,de.data,0,0);else Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else D?te&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,Q,0,0,0,de.width,de.height,$.depth,ee,ge,de.data):t.texImage3D(i.TEXTURE_2D_ARRAY,Q,_e,de.width,de.height,$.depth,0,ee,ge,de.data)}else{D&&se&&t.texStorage2D(i.TEXTURE_2D,pe,_e,ze[0].width,ze[0].height);for(let Q=0,j=ze.length;Q<j;Q++)de=ze[Q],b.format!==jt?ee!==null?D?te&&t.compressedTexSubImage2D(i.TEXTURE_2D,Q,0,0,de.width,de.height,ee,de.data):t.compressedTexImage2D(i.TEXTURE_2D,Q,_e,de.width,de.height,0,de.data):Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):D?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,de.width,de.height,ee,ge,de.data):t.texImage2D(i.TEXTURE_2D,Q,_e,de.width,de.height,0,ee,ge,de.data)}else if(b.isDataArrayTexture)if(D){if(se&&t.texStorage3D(i.TEXTURE_2D_ARRAY,pe,_e,$.width,$.height,$.depth),te)if(b.layerUpdates.size>0){const Q=Bc($.width,$.height,b.format,b.type);for(const j of b.layerUpdates){const be=$.data.subarray(j*Q/$.data.BYTES_PER_ELEMENT,(j+1)*Q/$.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,j,$.width,$.height,1,ee,ge,be)}b.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,$.width,$.height,$.depth,ee,ge,$.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,_e,$.width,$.height,$.depth,0,ee,ge,$.data);else if(b.isData3DTexture)D?(se&&t.texStorage3D(i.TEXTURE_3D,pe,_e,$.width,$.height,$.depth),te&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,$.width,$.height,$.depth,ee,ge,$.data)):t.texImage3D(i.TEXTURE_3D,0,_e,$.width,$.height,$.depth,0,ee,ge,$.data);else if(b.isFramebufferTexture){if(se)if(D)t.texStorage2D(i.TEXTURE_2D,pe,_e,$.width,$.height);else{let Q=$.width,j=$.height;for(let be=0;be<pe;be++)t.texImage2D(i.TEXTURE_2D,be,_e,Q,j,0,ee,ge,null),Q>>=1,j>>=1}}else if(ze.length>0){if(D&&se){const Q=ve(ze[0]);t.texStorage2D(i.TEXTURE_2D,pe,_e,Q.width,Q.height)}for(let Q=0,j=ze.length;Q<j;Q++)de=ze[Q],D?te&&t.texSubImage2D(i.TEXTURE_2D,Q,0,0,ee,ge,de):t.texImage2D(i.TEXTURE_2D,Q,_e,ee,ge,de);b.generateMipmaps=!1}else if(D){if(se){const Q=ve($);t.texStorage2D(i.TEXTURE_2D,pe,_e,Q.width,Q.height)}te&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ee,ge,$)}else t.texImage2D(i.TEXTURE_2D,0,_e,ee,ge,$);g(b)&&f(X),me.__version=q.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function ne(T,b,L){if(b.image.length!==6)return;const X=De(T,b),Y=b.source;t.bindTexture(i.TEXTURE_CUBE_MAP,T.__webglTexture,i.TEXTURE0+L);const q=n.get(Y);if(Y.version!==q.__version||X===!0){t.activeTexture(i.TEXTURE0+L);const me=We.getPrimaries(We.workingColorSpace),ie=b.colorSpace===Xn?null:We.getPrimaries(b.colorSpace),Te=b.colorSpace===Xn||me===ie?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,b.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,b.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Te);const we=b.isCompressedTexture||b.image[0].isCompressedTexture,$=b.image[0]&&b.image[0].isDataTexture,ee=[];for(let j=0;j<6;j++)!we&&!$?ee[j]=x(b.image[j],!0,s.maxCubemapSize):ee[j]=$?b.image[j].image:b.image[j],ee[j]=st(b,ee[j]);const ge=ee[0],_e=a.convert(b.format,b.colorSpace),de=a.convert(b.type),ze=E(b.internalFormat,_e,de,b.colorSpace),D=b.isVideoTexture!==!0,se=q.__version===void 0||X===!0,te=Y.dataReady;let pe=A(b,ge);oe(i.TEXTURE_CUBE_MAP,b);let Q;if(we){D&&se&&t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,ze,ge.width,ge.height);for(let j=0;j<6;j++){Q=ee[j].mipmaps;for(let be=0;be<Q.length;be++){const Le=Q[be];b.format!==jt?_e!==null?D?te&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,0,0,Le.width,Le.height,_e,Le.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,ze,Le.width,Le.height,0,Le.data):Ee("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,0,0,Le.width,Le.height,_e,de,Le.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be,ze,Le.width,Le.height,0,_e,de,Le.data)}}}else{if(Q=b.mipmaps,D&&se){Q.length>0&&pe++;const j=ve(ee[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,pe,ze,j.width,j.height)}for(let j=0;j<6;j++)if($){D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,ee[j].width,ee[j].height,_e,de,ee[j].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,ze,ee[j].width,ee[j].height,0,_e,de,ee[j].data);for(let be=0;be<Q.length;be++){const at=Q[be].image[j].image;D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,0,0,at.width,at.height,_e,de,at.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,ze,at.width,at.height,0,_e,de,at.data)}}else{D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,_e,de,ee[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,ze,_e,de,ee[j]);for(let be=0;be<Q.length;be++){const Le=Q[be];D?te&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,0,0,_e,de,Le.image[j]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+j,be+1,ze,_e,de,Le.image[j])}}}g(b)&&f(i.TEXTURE_CUBE_MAP),q.__version=Y.version,b.onUpdate&&b.onUpdate(b)}T.__version=b.version}function ae(T,b,L,X,Y,q){const me=a.convert(L.format,L.colorSpace),ie=a.convert(L.type),Te=E(L.internalFormat,me,ie,L.colorSpace),we=n.get(b),$=n.get(L);if($.__renderTarget=b,!we.__hasExternalTextures){const ee=Math.max(1,b.width>>q),ge=Math.max(1,b.height>>q);Y===i.TEXTURE_3D||Y===i.TEXTURE_2D_ARRAY?t.texImage3D(Y,q,Te,ee,ge,b.depth,0,me,ie,null):t.texImage2D(Y,q,Te,ee,ge,0,me,ie,null)}t.bindFramebuffer(i.FRAMEBUFFER,T),pt(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,Y,$.__webglTexture,0,P(b)):(Y===i.TEXTURE_2D||Y>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Y<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,Y,$.__webglTexture,q),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ne(T,b,L){if(i.bindRenderbuffer(i.RENDERBUFFER,T),b.depthBuffer){const X=b.depthTexture,Y=X&&X.isDepthTexture?X.type:null,q=S(b.stencilBuffer,Y),me=b.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;pt(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(b),q,b.width,b.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(b),q,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,q,b.width,b.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,me,i.RENDERBUFFER,T)}else{const X=b.textures;for(let Y=0;Y<X.length;Y++){const q=X[Y],me=a.convert(q.format,q.colorSpace),ie=a.convert(q.type),Te=E(q.internalFormat,me,ie,q.colorSpace);pt(b)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,P(b),Te,b.width,b.height):L?i.renderbufferStorageMultisample(i.RENDERBUFFER,P(b),Te,b.width,b.height):i.renderbufferStorage(i.RENDERBUFFER,Te,b.width,b.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ae(T,b,L){const X=b.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,T),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(b.depthTexture);if(Y.__renderTarget=b,(!Y.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),X){if(Y.__webglInit===void 0&&(Y.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),Y.__webglTexture===void 0){Y.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Y.__webglTexture),oe(i.TEXTURE_CUBE_MAP,b.depthTexture);const we=a.convert(b.depthTexture.format),$=a.convert(b.depthTexture.type);let ee;b.depthTexture.format===Un?ee=i.DEPTH_COMPONENT24:b.depthTexture.format===ci&&(ee=i.DEPTH24_STENCIL8);for(let ge=0;ge<6;ge++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+ge,0,ee,b.width,b.height,0,we,$,null)}}else O(b.depthTexture,0);const q=Y.__webglTexture,me=P(b),ie=X?i.TEXTURE_CUBE_MAP_POSITIVE_X+L:i.TEXTURE_2D,Te=b.depthTexture.format===ci?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(b.depthTexture.format===Un)pt(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Te,ie,q,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,Te,ie,q,0);else if(b.depthTexture.format===ci)pt(b)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,Te,ie,q,0,me):i.framebufferTexture2D(i.FRAMEBUFFER,Te,ie,q,0);else throw new Error("Unknown depthTexture format")}function Ce(T){const b=n.get(T),L=T.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==T.depthTexture){const X=T.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),X){const Y=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,X.removeEventListener("dispose",Y)};X.addEventListener("dispose",Y),b.__depthDisposeCallback=Y}b.__boundDepthTexture=X}if(T.depthTexture&&!b.__autoAllocateDepthBuffer)if(L)for(let X=0;X<6;X++)Ae(b.__webglFramebuffer[X],T,X);else{const X=T.texture.mipmaps;X&&X.length>0?Ae(b.__webglFramebuffer[0],T,0):Ae(b.__webglFramebuffer,T,0)}else if(L){b.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[X]),b.__webglDepthbuffer[X]===void 0)b.__webglDepthbuffer[X]=i.createRenderbuffer(),Ne(b.__webglDepthbuffer[X],T,!1);else{const Y=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=b.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,q)}}else{const X=T.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=i.createRenderbuffer(),Ne(b.__webglDepthbuffer,T,!1);else{const Y=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,q=b.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,q),i.framebufferRenderbuffer(i.FRAMEBUFFER,Y,i.RENDERBUFFER,q)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function Mt(T,b,L){const X=n.get(T);b!==void 0&&ae(X.__webglFramebuffer,T,T.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),L!==void 0&&Ce(T)}function je(T){const b=T.texture,L=n.get(T),X=n.get(b);T.addEventListener("dispose",C);const Y=T.textures,q=T.isWebGLCubeRenderTarget===!0,me=Y.length>1;if(me||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=b.version,r.memory.textures++),q){L.__webglFramebuffer=[];for(let ie=0;ie<6;ie++)if(b.mipmaps&&b.mipmaps.length>0){L.__webglFramebuffer[ie]=[];for(let Te=0;Te<b.mipmaps.length;Te++)L.__webglFramebuffer[ie][Te]=i.createFramebuffer()}else L.__webglFramebuffer[ie]=i.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){L.__webglFramebuffer=[];for(let ie=0;ie<b.mipmaps.length;ie++)L.__webglFramebuffer[ie]=i.createFramebuffer()}else L.__webglFramebuffer=i.createFramebuffer();if(me)for(let ie=0,Te=Y.length;ie<Te;ie++){const we=n.get(Y[ie]);we.__webglTexture===void 0&&(we.__webglTexture=i.createTexture(),r.memory.textures++)}if(T.samples>0&&pt(T)===!1){L.__webglMultisampledFramebuffer=i.createFramebuffer(),L.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,L.__webglMultisampledFramebuffer);for(let ie=0;ie<Y.length;ie++){const Te=Y[ie];L.__webglColorRenderbuffer[ie]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,L.__webglColorRenderbuffer[ie]);const we=a.convert(Te.format,Te.colorSpace),$=a.convert(Te.type),ee=E(Te.internalFormat,we,$,Te.colorSpace,T.isXRRenderTarget===!0),ge=P(T);i.renderbufferStorageMultisample(i.RENDERBUFFER,ge,ee,T.width,T.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ie,i.RENDERBUFFER,L.__webglColorRenderbuffer[ie])}i.bindRenderbuffer(i.RENDERBUFFER,null),T.depthBuffer&&(L.__webglDepthRenderbuffer=i.createRenderbuffer(),Ne(L.__webglDepthRenderbuffer,T,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(q){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),oe(i.TEXTURE_CUBE_MAP,b);for(let ie=0;ie<6;ie++)if(b.mipmaps&&b.mipmaps.length>0)for(let Te=0;Te<b.mipmaps.length;Te++)ae(L.__webglFramebuffer[ie][Te],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Te);else ae(L.__webglFramebuffer[ie],T,b,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0);g(b)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(me){for(let ie=0,Te=Y.length;ie<Te;ie++){const we=Y[ie],$=n.get(we);let ee=i.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ee=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ee,$.__webglTexture),oe(ee,we),ae(L.__webglFramebuffer,T,we,i.COLOR_ATTACHMENT0+ie,ee,0),g(we)&&f(ee)}t.unbindTexture()}else{let ie=i.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(ie=T.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ie,X.__webglTexture),oe(ie,b),b.mipmaps&&b.mipmaps.length>0)for(let Te=0;Te<b.mipmaps.length;Te++)ae(L.__webglFramebuffer[Te],T,b,i.COLOR_ATTACHMENT0,ie,Te);else ae(L.__webglFramebuffer,T,b,i.COLOR_ATTACHMENT0,ie,0);g(b)&&f(ie),t.unbindTexture()}T.depthBuffer&&Ce(T)}function Ke(T){const b=T.textures;for(let L=0,X=b.length;L<X;L++){const Y=b[L];if(g(Y)){const q=v(T),me=n.get(Y).__webglTexture;t.bindTexture(q,me),f(q),t.unbindTexture()}}}const nt=[],Be=[];function ut(T){if(T.samples>0){if(pt(T)===!1){const b=T.textures,L=T.width,X=T.height;let Y=i.COLOR_BUFFER_BIT;const q=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,me=n.get(T),ie=b.length>1;if(ie)for(let we=0;we<b.length;we++)t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,me.__webglMultisampledFramebuffer);const Te=T.texture.mipmaps;Te&&Te.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglFramebuffer);for(let we=0;we<b.length;we++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(Y|=i.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(Y|=i.STENCIL_BUFFER_BIT)),ie){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,me.__webglColorRenderbuffer[we]);const $=n.get(b[we]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,$,0)}i.blitFramebuffer(0,0,L,X,0,0,L,X,Y,i.NEAREST),l===!0&&(nt.length=0,Be.length=0,nt.push(i.COLOR_ATTACHMENT0+we),T.depthBuffer&&T.resolveDepthBuffer===!1&&(nt.push(q),Be.push(q),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,Be)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,nt))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ie)for(let we=0;we<b.length;we++){t.bindFramebuffer(i.FRAMEBUFFER,me.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.RENDERBUFFER,me.__webglColorRenderbuffer[we]);const $=n.get(b[we]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,me.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+we,i.TEXTURE_2D,$,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,me.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const b=T.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[b])}}}function P(T){return Math.min(s.maxSamples,T.samples)}function pt(T){const b=n.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function Xe(T){const b=r.render.frame;h.get(T)!==b&&(h.set(T,b),T.update())}function st(T,b){const L=T.colorSpace,X=T.format,Y=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||L!==Ft&&L!==Xn&&(We.getTransfer(L)===Je?(X!==jt||Y!==Gt)&&Ee("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Re("WebGLTextures: Unsupported texture color space:",L)),b}function ve(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(c.width=T.naturalWidth||T.width,c.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(c.width=T.displayWidth,c.height=T.displayHeight):(c.width=T.width,c.height=T.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=B,this.setTexture2D=O,this.setTexture2DArray=U,this.setTexture3D=I,this.setTextureCube=Z,this.rebindTextures=Mt,this.setupRenderTarget=je,this.updateRenderTargetMipmap=Ke,this.updateMultisampleRenderTarget=ut,this.setupDepthRenderbuffer=Ce,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=pt,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function Sb(i,e){function t(n,s=Xn){let a;const r=We.getTransfer(s);if(n===Gt)return i.UNSIGNED_BYTE;if(n===go)return i.UNSIGNED_SHORT_4_4_4_4;if(n===bo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Dl)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Ll)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Cl)return i.BYTE;if(n===Pl)return i.SHORT;if(n===gs)return i.UNSIGNED_SHORT;if(n===mo)return i.INT;if(n===gn)return i.UNSIGNED_INT;if(n===Wt)return i.FLOAT;if(n===Nn)return i.HALF_FLOAT;if(n===Il)return i.ALPHA;if(n===Fl)return i.RGB;if(n===jt)return i.RGBA;if(n===Un)return i.DEPTH_COMPONENT;if(n===ci)return i.DEPTH_STENCIL;if(n===_o)return i.RED;if(n===xo)return i.RED_INTEGER;if(n===Bi)return i.RG;if(n===vo)return i.RG_INTEGER;if(n===Mo)return i.RGBA_INTEGER;if(n===ra||n===oa||n===ca||n===la)if(r===Je)if(a=e.get("WEBGL_compressed_texture_s3tc_srgb"),a!==null){if(n===ra)return a.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===oa)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===ca)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===la)return a.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(a=e.get("WEBGL_compressed_texture_s3tc"),a!==null){if(n===ra)return a.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===oa)return a.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===ca)return a.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===la)return a.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Er||n===yr||n===Tr||n===Ar)if(a=e.get("WEBGL_compressed_texture_pvrtc"),a!==null){if(n===Er)return a.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===yr)return a.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Tr)return a.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ar)return a.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===wr||n===Rr||n===Cr||n===Pr||n===Dr||n===Lr||n===Ir)if(a=e.get("WEBGL_compressed_texture_etc"),a!==null){if(n===wr||n===Rr)return r===Je?a.COMPRESSED_SRGB8_ETC2:a.COMPRESSED_RGB8_ETC2;if(n===Cr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:a.COMPRESSED_RGBA8_ETC2_EAC;if(n===Pr)return a.COMPRESSED_R11_EAC;if(n===Dr)return a.COMPRESSED_SIGNED_R11_EAC;if(n===Lr)return a.COMPRESSED_RG11_EAC;if(n===Ir)return a.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Fr||n===Nr||n===Ur||n===Or||n===kr||n===Br||n===zr||n===Gr||n===Vr||n===Hr||n===Wr||n===jr||n===qr||n===Xr)if(a=e.get("WEBGL_compressed_texture_astc"),a!==null){if(n===Fr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:a.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Nr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:a.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Ur)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:a.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Or)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:a.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===kr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:a.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Br)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:a.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===zr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:a.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Gr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:a.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Vr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:a.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===Hr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:a.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Wr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:a.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===jr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:a.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===qr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:a.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Xr)return r===Je?a.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:a.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Kr||n===Yr||n===Jr)if(a=e.get("EXT_texture_compression_bptc"),a!==null){if(n===Kr)return r===Je?a.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:a.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Yr)return a.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Jr)return a.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===Zr||n===$r||n===Qr||n===eo)if(a=e.get("EXT_texture_compression_rgtc"),a!==null){if(n===Zr)return a.COMPRESSED_RED_RGTC1_EXT;if(n===$r)return a.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Qr)return a.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===eo)return a.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===bs?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Eb=`
void main() {
